...
public class PrimaryJpaConfig {
    static final String REPOSITORY_PACKAGE = "com.kao.jpa.repository.primary";
    private static final String ENTITY_PACKAGE = "com.kao.jpa.entity.primary";
