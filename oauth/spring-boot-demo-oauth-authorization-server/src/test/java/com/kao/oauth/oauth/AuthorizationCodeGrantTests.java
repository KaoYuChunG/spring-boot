...
public class AuthorizationCodeGrantTests {
    ...
    void setUp() {
        ...
        resource.setAccessTokenUri(AuthorizationServerInfo.getUrl("/oauth/token"));
        resource.setUserAuthorizationUri(AuthorizationServerInfo.getUrl("/oauth/authorize"));
    }
    ...
    void testCannotConnectWithoutToken() {
        ...
        assertThrows(UserRedirectRequiredException.class,
            () -> template.getForObject(AuthorizationServerInfo.getUrl("/oauth/me"), String.class));
    }
